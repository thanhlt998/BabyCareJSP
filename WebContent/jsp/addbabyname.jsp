	...
	<header>
		<nav>
			<ul class="main-nav clearfix">
				...
				<li><a href="addBaby">Add Baby</a></li>
		...
		<div class="row box-form">
			...
			<form class="add-baby-form" action="addBaby" method="post">
				<div>
					<%
						if (request.getAttribute("addBabyMessage") != null) {
					%>
					<p><%=(String) request.getAttribute("addBabyMessage")%>
					<p>
						<%
							} else {
						%>
				...
				<div class="row">
					...
					<div class="col span-2-of-3">
						<input type="text" name="name" id="name" placeholder="Baby Name">
					</div>
				</div>
				<div class="row">
					<div class="col span-1-of-3">
				...
				<div class="row">
					...
					<div class="col span-2-of-3">
						<button type="submit">Add a baby name</button>
					</div>
				</div>
